...
- [x] (2 pts) **Most recently fetched data is stored locally in a database**
  ...
  - ![GIF showing database caching functionality](Lab5_1.gif) <!-- Replace this link with your actual image/GIF link -->

- [x] (2 pts) **If user turns on airplane mode and closes and reopens app, old data from the database should be loaded**
  - ![GIF showing offline mode functionality](Lab5_2.gif) <!-- Replace this link with your actual image/GIF link -->
